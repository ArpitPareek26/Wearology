...
//   // Single unified function to handle login
//   const handleSubmit = async (e) => {
//     e.preventDefault();

//     // Build the form data from component state (assuming formData is defined)
...
//         // Save token, update auth state, and navigate
...
//         } else if (status === 409) {
//           toast.error("User already exists!"); // In case this endpoint ever returns 409 on login
//         } else if (status === 500) {
